                ...
                >
                    ...
                    <div className="text">
                        <div className="absolute inset-0 flex justify-center items-center p-20">
                            <p className=" group text-blue-1 min-w-[800px] max-w-[800px] text-6xl font-bold flex justify-center items-center group-hover:opacity-0 transition-all duration-300 z-20">BLUE
                                TEAM</p>
                        </div>
                        <div className="absolute inset-0 flex justify-center items-center p-20">
                            <p className="text-white group-hover:opacity-100 min-w-[800px] max-w-[800px] opacity-0 transition-all duration-700 text-xl z-20">
                                Blue Team oferuje profesjonalne wdrożenia zarówno komercyjnych, jak i Open Source
                                rozwiązań, zapewniając kompleksową obsługę technologiczną dla
                                firm.<br/><br/> Specjalizujemy się w szkoleniach z zakresu cyberbezpieczeństwa, ciągłym
                                monitorowaniu infrastruktury IT (SOC), oraz II linii wsparcia
                                technicznego.<br/><br/> Dodatkowo, oferujemy usługi odmiejscowienia kopii zapasowych,
                                gwarantując bezpieczeństwo danych w każdej sytuacji.</p>
                        </div>
                    </div>
                </Link>
                <Link
                ...
                >
                    ...
                    <div className="text">
                        <div className="absolute group inset-0 flex justify-center items-center p-20">
                            <p className="text-red-700 min-w-[800px] max-w-[800px] text-6xl font-bold flex justify-center items-center group-hover:opacity-0 transition-all duration-300 z-20">RED
                                TEAM</p>
                        </div>
                        <div className="absolute inset-0 flex justify-center items-center p-20">
                            <p className="text-white group-hover:opacity-100 min-w-[800px] max-w-[800px] opacity-0 transition-all duration-700 text-xl z-20">
